...
namespace SampleCode
{
    ...
    internal sealed class Program
    {
        ...
        /// <summary>Executes the polling operation.</summary>
        ///
        ...
        {
            Console.Title = "Animal Fact Logger Application - Press [Return] Key to Exit";
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("*********************************************************************");
            Console.WriteLine("**");
            Console.WriteLine("** Animal Fact Logger Application");
        ...
        {
            if (!(System.AppContext.GetData("FactLogFile") is string filePath))
            {
            ...
            builder.Register(l => new FileFactLogger(filePath)).As<IAnimalFactLogger>();
            builder.RegisterType<AnimalFacts>().As<IAnimalFacts>();
            builder.RegisterType<PollingEngine>().As<IPollingEngine>();
